      ...
      <div className="ng-input-node-body">
        <div className="ng-color-row">
          <input
            type="color"
            value={hex}
            className="ng-color-picker ng-interactive"
            onChange={(e) =>
              updateColor(hexToRgba(e.target.value, val[3] ?? 1))
            }
          ...
          <input
            type="text"
            value={hexInput}
            className="ng-input-node-field ng-interactive ng-color-hex"
...
registerNode("color_value", {
  ...
  defaultConfig: {
    ...
    description: {
      en: "RGBA color input with color picker",
      ko: "RGBA 색상 입력",
    },
  },
