      ...
      <div className="detail-header">
        <div className="detail-tabs">
          <button
            ...
            onClick={() =>
              dispatch({ type: "SET_ACTIVE_DETAIL_TAB", payload: "plan" })
            }
          >
            {t("label.tab_plan")}
          </button>
          ...
          <button
            ...
            onClick={() =>
              dispatch({ type: "SET_ACTIVE_DETAIL_TAB", payload: "code" })
            }
          >
            {t("label.tab_code")}
          </button>
          <button
            ...
            onClick={() =>
              dispatch({ type: "SET_ACTIVE_DETAIL_TAB", payload: "outputs" })
            }
          >
            {t("label.tab_outputs")}
          </button>
...
=======
        <div
          ...
          style={{
            display: activeTab === "plan" ? "flex" : "none",
        ...
        <div
          className="detail-tab-content"
          style={{
            display: activeTab === "outputs" ? "flex" : "none",
            flexDirection: "column" as const,
            height: "100%",
            overflow: "hidden",
          }}
